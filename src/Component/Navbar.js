  ...
  <div className="container-fluid ">
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          {auth?<Link onClick={post} className="nav-link px-3 text-light" to="/login">Logout</Link>:<Link className="nav-link px-3 text-light" to="/signup">SignUp</Link>}
        </li>
        <li className="nav-item">
          <Link className="nav-link px-3 text-light" to="/login">Login</Link>
        </li>
     </ul>
    </div>
  </div>
